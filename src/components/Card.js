    ...
    return (
        <div className="flex flex-col md:relative">
            <div className="absolute top-[-7rem] z-10 mx-auto ">
                ...
                <div className="w-[140px] h-[140px] bg-pink-800 rounded-full absolute top-[-6px] z-[-10] left-[10px]"></div>
            </div>
            ...
            <div className="  text text-center mt-4 text-slate-500  ">{review.text}</div>
